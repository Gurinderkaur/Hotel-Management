...
<div class="clearfix"></div>
	...
	<div class="content">
		...
		$q="select catres.rid,catres.rname,catres.rusername,ordertable.orderid,ordertable.dname,ordertable.address,ordertable.date,ordertable.quantity,ordertable.customername,ordertable.status from catres,ordertable where catres.rid=ordertable.rid and catres.rusername='$un'";
			...
			else
			{
				 print"<table width='100%' border='0' align='center'>
					...
					while($x=mysqli_fetch_array($result))
					{
						...
						<td>$x[quantity]</td>
						<td>$x[date]</td>
						<td><a href='updateorders.php?id=$x[orderid]'>$x[status]</a></td>
