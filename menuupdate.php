...
<div class="clearfix"></div>
	...
	<div class="content">
		...
		$q="select * from menu where username='$un'";
			...
			else
			{
				 print"<table width='100%' border='0'>
					...
					while($x=mysqli_fetch_array($result))
					{
						print"
						<tr>	
						<td align='center'><img src='uploads/$x[5]' width='140' height='120'></td>
						<td align='center'>$x[1]</td>
						<td align='center'>Rs&nbsp;&nbsp;$x[4]/-</td>
						<td align='center'>$x[3]%</td>
						<td align='center'>$x[2]</td>
						<td align='center'><a href='updatingmenu.php?id=$x[pid]'>Update</a></td>
						<td align='center'><a href='deletemenu.php?id=$x[pid]'>Delete</a></td>
						</tr>";
					}
