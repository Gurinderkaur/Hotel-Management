		...
		<div class="special-offers-section">
			<div class="container">
			  ...
			  <table width="100%" border="0">
			    ...
			    <tr>
			      <td>Cuisine Name</td>
			      <td><input name="cname" type="text" id="cname" size="50" value="<?php print $cname ?>" ></td>
		        </tr>
			    <tr>
			      <td>&nbsp;</td>
			      <td>&nbsp;</td>
			    ...
			    <tr>
			      <td>Rate</td>
			      <td><label>
			        <input type="text" name="total" id="total" value="<?php  print $remamt; ?>">
			        </label></td>
		        </tr>
			    <tr>
			      <td>&nbsp;</td>
			    ...
			    <tr>
			      <td>&nbsp;</td>
			      <td><input type="submit" name="done" id="done" value="Order">
		          <input type="submit" name="cshop" id="cshop" value="Continue Shopping"></td>
		        </tr>
		      </table>
	      </div>
		</div>
