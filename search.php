		    ...
		    <div class="container">
				<div class="banner-info">
					...
					<div class="form-list wow fadeInRight" data-wow-delay="0.5s">
						<form method="post">
						  <p><span>Username / Email ID</span>
						    <input name="email" type="text" class="text" id="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Swagath Grand';}" value="xyz@gmail.com">
