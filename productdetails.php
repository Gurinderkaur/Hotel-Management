			...
			else
			{
				 print"<table width='100%' border='0'>
				 	<tr>
						...
						<th><center><h3><b>Restaurant Name</b></h3></center></th>
						<th><center><h3><b>Restaurant Type</b></h3></center></th>
						<th><center><h3><b>Location</b></h3></center></th>
						<th><center><h3><b>Update</b></h3></center></th>
						<th><center><h3><b>Delete</b></h3></center></th>
				 	</tr>";
					...
					while($x=mysqli_fetch_array($result))
					{
						print"
						<tr>	
						<td align='center'><img src='uploads/$x[2]' width='140' height='120'></td>
						<td align='center'>$x[1]</td>
						<td align='center'>$x[4]</td>
						<td align='center'>$x[3]</td>
						<td align='center'><a href='update.php?rid=$x[0]'>Update</a></td>
						<td align='center'><a href='delete.php?rid=$x[0]'>Delete</a></td>
						</tr>";
					}
