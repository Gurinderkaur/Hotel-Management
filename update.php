...
$conn=mysqli_connect(host,un,pass,db) or die("error in connection".mysqli_connect_error());
	...
	$q="select * from catres where rid='$id'";
...
if(isset($_POST["update"]))
{
	...
	$q="update catres set rname='$rname',rlocation='$rloc',rpic='$rpic',rtype='$rtype' where rid='$id'";
				...
				<div class="special-offers-section-head text-center dotted-line">
					...
					<form action="" method="post" enctype="multipart/form-data" name="form1">
					  <table width="100%" border="0">
					    ...
					    <tr>
					      <td height="35" align="center"><strong><h3><b>Restaurant Name</b></h3></strong></td>
					      <td><label>
					        <input name="name" type="text" id="cname" size="100" value="<?php print $x[1]?>">
				          </label></td>
				        </tr>
					    <tr>
					    ...
					    <tr>
					      <td height="40" align="center"><h3><strong>Restaurant Type</strong></h3></td>
					      <td><label>
					    ...
					    <tr>
					      <td height="43" align="center"><h3><b>Restaurant Location</b></h3></td>
					      <td><label>
					        <input name="location" type="text" id="location" size="100" value="<?php 		print $x[3]?>">
				          </label></td>
				        </tr>
					    <tr>
					    ...
					    <tr>
					      <td height="64" align="center"><strong><h3><b>Restaurant Pic</b></h3></strong></td>
					      <td align="left">
                          <?php
						  
						   
						  print "<img src='uploads/$x[2]' height='75'>";
