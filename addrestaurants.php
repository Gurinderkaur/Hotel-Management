...
if(isset($_POST["add"]))
{
	...
	if($err==0)
	{
		...
		$rpic=$tstamp.$_FILES["img"]["name"];
		$tname=$_FILES["img"]["tmp_name"];
		move_uploaded_file($tname,"uploads/$rpic");
	}
	else
	{
		$rpic="no-image.png";	
	...
	$q="insert into catres(rname,rpic,rlocation,rtype,rusername) values('$rname','$rpic','$rloc','$rtype','$un')";
...
function xyz()
{
	...
	if(document.form1.type.value.length<2)
	{
		alert("Please Restaurant Type");
		return false;
	}


	
	if(document.form1.location.value.length<=2)
	{
		alert("Enter the Restaurant Location");
		return false;
	}
}
 </script> 
...
<div class="special-offers-section">
			<div class="container">
				<div class="special-offers-section-head text-center dotted-line">
					...
					<p>&nbsp; </p>
					<form  method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return xyz()">
					  <table width="100%" border="0">
					    ...
					    <tr>
					      <td align="center"><strong><h3><b>Restaurant Name</b></h3></strong></td>
					      <td><label>
					        <input name="name" type="text" id="cname" size="100">
				          </label></td>
				        </tr>
					    <tr>
					      <td align="center">&nbsp;</td>
					    ...
					    <tr>
					      <td align="center"><h3><strong>Restaurant Type</strong></h3></td>
					      <td><label>
					        <input name="type" type="text" id="type" size="100">
				          </label></td>
				        </tr>
					    <tr>
					      <td align="center">&nbsp;</td>
					    ...
					    <tr>
					      <td align="center"><h3><b>Restaurant Location</b></h3></td>
					      <td><label>
					        <input name="location" type="text" id="location" size="100">
				          </label></td>
				        </tr>
					    <tr>
					      <td align="center">&nbsp;</td>
					    ...
					    <tr>
					      ...
					      <td valign="middle"><input type="submit" name="add" id="add" value="Add Restaurant"></td>
				        </tr>
					    <tr>
					      <td align="center">&nbsp;</td>
					      <td valign="middle">&nbsp;</td>
