<?php
	...
	$q="select * from ordertable where orderid='$oid'";
	...
	$q="update ordertable set status='$cstatus' where orderid='$oid'";
	$res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
	$cnt=mysqli_affected_rows($conn);
		      ...
		      <form name="form1" method="post" action="">
		        <table width="100%" border="0">
		          ...
		          <tr>
	                ...
	                <input name="status" type="text" id="status" size="50" value="<?php
		print $x['status'];
					?>
                    "></td>
	              </tr>
		          ...
		          <tr>
		            ...
		            <td><select name="st" id="st">
		              <option>Order Left for deliver</option>
