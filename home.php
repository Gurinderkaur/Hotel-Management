	...
	<div class="content">
	  <div class="popular-restaurents" id="Popular-Restaurants">
		...
		mysqli_close($conn);
			...
			<a href='page2.php?rid=$x[0]'><img src='uploads/$x[2]' width='180' height='174'><br/></a>
				</td>";
		...
		mysqli_close($conn);
			...
			<a href='addtocart.php?id=$x[pid]'><img src='uploads/$x[dpic]' width='180' height='180'><br/>$x[1]<br/>Rs. $x[4]/-<br/></a>&nbsp;&nbsp;
				</td>";
		...
		<div class="service-section">
			<div class="service-section-top-row"></div>
