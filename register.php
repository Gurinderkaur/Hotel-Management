...
<?php
	...
	if(isset($_POST["register"]))
	{
		...
		$confirmed=$_POST["confirmp"];	
		
		
				$conn=mysqli_connect(host,un,pass,db) or die("error in connection".mysqli_connect_error());
				$q="insert into signup values('$firstname','$lastname','$username','$password','$usertype')";
			mysqli_query($conn,$q) or die(header("location:NotReached.php"));
			...
			{
				header("location:NotReached.php");	
			}
...
function xyz()
{
	...
	{
		alert("Password should be of Atleast 2 digit/alpabets");
		return false;
	}
	
	if(document.form1.confirmp.value.length<=2)
	{
	...
	p2=document.form1.confirmp.value
	if(p1!=p2)
	{
...
<body>
	...
	<div class="main">
	   <div class="container">
		  <div class="register">
		  	  <form name="form1" method="post" onSubmit="return xyz()"> 
				     ...
				     <div class="register-bottom-grid">
						    ...
						    <div class="wow fadeInLeft" data-wow-delay="0.4s">
						      <span>Password<label>*</label></span>
								<input name="password" type="password" id="password" size="85">
					   </div>
							 <div class="wow fadeInRight" data-wow-delay="0.4s">
							   <span>Confirm Password<label>*</label></span>
								<input name="confirmp" type="password" id="confirmp" size="80">
							 </div>
